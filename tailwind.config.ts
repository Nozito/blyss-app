  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        blyss: {
          pink: "hsl(var(--blyss-pink))",
          "pink-light": "hsl(var(--blyss-pink-light))",
          gold: "hsl(var(--blyss-gold))",
          "gold-light": "hsl(var(--blyss-gold-light))",
          cream: "hsl(var(--blyss-cream))",
        },
      },
      fontFamily: {
      ...
      spacing: {
        "safe-bottom": "max(env(safe-area-inset-bottom), 1.5rem)",
