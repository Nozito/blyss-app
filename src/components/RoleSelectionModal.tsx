...
import { Briefcase, Shield, X, Sparkles, TrendingUp, Users, Heart } from "lucide-react";
...
const SHIMMER = (delay = 0) => (
  <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-700">
    <motion.div
      ...
      animate={{ x: ["-100%", "200%"] }}
      transition={{ duration: 1.5, repeat: Infinity, repeatDelay: 2, delay }}
    />
  </div>
);
          ...
          >
            <div className="relative bg-card rounded-[2rem] p-8 shadow-2xl border border-border overflow-hidden">
              ...
              <div className="space-y-3 relative z-10">
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-rose-400 via-pink-500 to-fuchsia-500 opacity-100" />
                  {SHIMMER(0)}
                  <div className="relative flex items-center gap-4 p-5">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-1.5 text-white/90 text-xs mb-1 drop-shadow-sm">
                        <Users size={12} />
                        <span className="font-medium">Réservations & favoris</span>
                      </div>
                      <div className="flex items-center gap-1 text-[11px] text-white/75 drop-shadow-sm">
                        <Sparkles size={11} />
                        <span className="font-medium">Vue utilisateur finale</span>
                      </div>
                    </div>
                    {ARROW}
                  </div>
