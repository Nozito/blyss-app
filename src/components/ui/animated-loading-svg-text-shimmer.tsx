...
export function LoadingBreadcrumb({ text = "Chargement", className, showChevron = true }: LoadingBreadcrumbProps) {
  return (
    <>
      <style>{`
      ...
      <div className={cn("flex items-center gap-2 text-[15px] font-medium tracking-wide", className)}>
        ...
        {showChevron && <ChevronRight size={16} className="text-muted-foreground/60" />}
      </div>
