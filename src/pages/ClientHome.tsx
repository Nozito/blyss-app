        ...
        <section className="space-y-3 mb-4">
          ...
          <div className="flex items-center justify-between gap-2 px-4">
            ...
            <button
              ...
              className="flex-shrink-0 text-[11px] text-primary px-3 py-1 rounded-full bg-primary/5 active:scale-[0.98] transition"
            >
              Tout voir
            </button>
          </div>
          ...
          {isLoading ? (
            <div className="flex gap-3 overflow-x-auto no-scrollbar py-1 px-4">
              {[1, 2, 3].map((i) => (
                <div
                  key={i}
                  className="min-w-[260px] bg-card rounded-3xl shadow-card animate-pulse"
                >
