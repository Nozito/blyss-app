...
const REVIEWS_MOCK = [
  {
    ...
    rating: 5,
    comment:
      "Marie est une artiste ! Mes ongles n'ont jamais été aussi beaux. Je recommande à 100%",
    date: "Il y a 2 jours",
    avatar: "SM"
  },
  {
    ...
    rating: 5,
    comment:
      "Superbe travail, très professionnelle et à l'écoute. Le nail art est magnifique !",
  ...
  },
  {
    ...
    rating: 4,
    comment:
      "Très satisfaite de ma manucure. Seul petit bémol, un peu d'attente à l'arrivée.",
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "Toujours au top ! Cela fait 2 ans que je viens chez Marie et je ne changerai pour rien au monde.",
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "Un vrai plaisir à chaque visite. Ambiance zen et résultat impeccable.",
    date: "Il y a 1 mois",
    avatar: "LP"
  }
];
...
const SpecialistProfile = () => {
  ...
  const selectedSpecialist = useMemo(() => {
    ...
    return SPECIALISTS.find((s) => s.id === numericId) ?? SPECIALISTS[0];
  }, [id]);
  ...
  const handleToggleFavorite = () => {
    ...
    toggleFavorite({
      ...
      location:
        specialist.location.split(",")[1]?.trim() || specialist.location,
  ...
  const bannerSrc = BANNERS[selectedSpecialist.id] || banner1;
    ...
    <>
      <MobileLayout showNav={false}>
        ...
        <div className="px-5 pt-16 pb-32 space-y-6">
          ...
          {/* À propos */}
          <section className="bg-card rounded-2xl p-4 shadow-card animate-slide-up">
          ...
          >
            <div className="flex items-center justify-between mb-1">
              ...
              <span className="text-xs text-muted-foreground">
                {specialist.services.length} services
              </span>
            </div>
          ...
          <section className="animate-slide-up" style={{ animationDelay: "0.08s" }}>
            ...
            >
              Réserver avec {specialist.name.split(" ")[0]}
            </button>
          </section>
          ...
          <div className="w-full max-w-[430px] bg-card rounded-t-3xl p-6 pb-10 animate-slide-up-modal">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                disabled={rating === 0}
                className="flex-1 py-3 rounded-xl gradient-primary text-primary-foreground font-medium active:scale-95 transition-transform disabled:opacity-50 text-sm"
              >
                Envoyer
              </button>
            </div>
