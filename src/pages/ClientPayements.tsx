    ...
    <MobileLayout>
      <div className="pb-8">
        <div className="flex items-center mb-4">
          <button onClick={() => navigate("/client")} className="w-10 h-10 rounded-xl bg-muted hover:bg-muted-foreground/10 flex items-center justify-center active:scale-95 transition-all">
